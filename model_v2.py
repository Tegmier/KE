...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        # init h
        h1 = Variable(torch.zeros(batch_size, self.hidden_size1))
        h2 = Variable(torch.zeros(batch_size, self.hidden_size2))
...
if __name__ == '__main__':
    ...
    model = Model(vocab_size=vocab_size, ny=y_nclasses, nz=z_nclasses, model_cell='gru')
